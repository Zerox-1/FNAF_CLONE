...
@Composable
fun Left1(x: MutableState<Int>, y:Int) {
    if (y == 1) {
        Image(
            bitmap = ImageBitmap.imageResource(R.drawable.left2),
            contentScale = ContentScale.Crop,
            contentDescription = "Левый коридор",
            modifier = Modifier
                .fillMaxSize()
                .offset(-1.dp, 0.dp)
        )
        ...
        Image(
            bitmap = ImageBitmap.imageResource(R.drawable.left),
            contentScale = ContentScale.Crop,
